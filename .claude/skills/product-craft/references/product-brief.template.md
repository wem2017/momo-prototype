...
## Mục đích
File trung gian tạo SAU quá trình clarify với Owner. Tổng hợp toàn bộ câu trả lời thành "contract" rõ ràng trước khi build. Lưu tại `pipeline-output/{runId}/po/product-brief.md`.
...
| Trigger | Hành động |
|---------|-----------|
| Mode B (Clarify) | Sau khi Owner trả lời đủ 4 mandatory elements + Reference Discovery → tạo Product Brief → confirm → chạy Premise Check + Scope Options → po-orchestrator chuyển Phase B |
